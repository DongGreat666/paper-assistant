            ...
            rx.hstack(
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.switch(
                            checked=HomeState.model_auto,
                            on_change=HomeState.toggle_model_auto,
                        ),
                        spacing="2",
                        align="center",
                    ),
                ...
                rx.vstack(
                    rx.hstack(
                        ...
                        rx.cond(
                            ...
                            rx.box(
                                rx.text(
                                    HomeState.saved_engines.length(),
...
def engine_card(profile) -> rx.Component:
    ...
    return rx.box(
            ...
            rx.vstack(
                rx.hstack(
                    ...
                    rx.box(
                        rx.text(
                            profile["model"],
                            font_size="calc(var(--base-font) * 0.6)",
                            font_weight="600",
                            color="#475569",
                            no_of_lines=1,
                        ),
            ...
            rx.menu.root(
                ...
                rx.menu.content(
                    ...
                    rx.menu.item(
                        ...
                        "测试连接",
                        on_click=HomeState.test_engine(profile["id"]),
                    ),
                    rx.menu.item(
                        rx.icon(tag="pencil", size=14),
                        "编辑",
                        on_click=HomeState.start_edit_engine(profile["id"]),
                    ),
                    rx.menu.item(
                        rx.icon(tag="trash_2", size=14),
                        "删除",
                        color="red",
                        on_click=HomeState.delete_engine(profile["id"]),
                    ),
                ),
            ),
            spacing="2",
        ...
        border_radius="8px",
        border=rx.cond(is_editing, "1.5px solid #2f5bea", "1px solid transparent"),
        bg=rx.cond(
            is_selected,
